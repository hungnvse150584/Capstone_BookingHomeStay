        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WantedHostShare = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CleaningRate = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    remainingBalance = table.Column<double>(type: "float", nullable: false),
                    isPaidWithBooking = table.Column<bool>(type: "bit", nullable: false),
                    AccountID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    HomeStayID = table.Column<int>(type: "int", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dayRent = table.Column<int>(type: "int", nullable: true),
                    RentHour = table.Column<int>(type: "int", nullable: true),
                    TotalAmount = table.Column<double>(type: "float", nullable: false),
                    ServicesID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerAmount = table.Column<double>(type: "float", nullable: false),
                    AdminAmount = table.Column<double>(type: "float", nullable: false),
